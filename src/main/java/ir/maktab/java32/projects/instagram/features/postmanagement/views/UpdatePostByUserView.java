...
import ir.maktab.java32.projects.instagram.features.postmanagement.services.impl.UpdatePostByUserUseCaseImpl;
import ir.maktab.java32.projects.instagram.features.shared.service.AuthenticationService;

import java.util.Scanner;

public class UpdatePostByUserView {
    ...
    public void view() {
        ...
        if (new UpdatePostByUserUseCaseImpl().update(post) != null)
